...
class EditorVideoPositionMenu implements ISelectMenu {
  readonly title = t('justify.editPosition')
  readonly tag = 'button'
  ...
  getOptions(editor: IDomEditor): IOption[] {
    ...
    const options = [
      // value 和 elemNode.type 对应
      {
        ...
        styleForRenderMenuList: { display: 'flex', 'justify-content': 'center' },
      },
      {
        value: 'right',
        text: t('justify.right'),
        styleForRenderMenuList: { display: 'flex', 'justify-content': 'right' },
      },
      {
        value: 'left',
        text: t('justify.left'),
        styleForRenderMenuList: { display: 'flex', 'justify-content': 'left' },
      },
    ]
